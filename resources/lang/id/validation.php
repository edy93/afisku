...
return [
    ...
    */
    ...
    'after_or_equal'       => 'Isian :attribute harus tanggal sesudah atau sama dengan tanggal :date.',
    'alpha'                => 'Isian :attribute hanya boleh berisi huruf.',
    'alpha_dash'           => 'Isian :attribute hanya boleh berisi huruf, angka, dan strip.',
    'alpha_num'            => 'Isian :attribute hanya boleh berisi huruf dan angka.',
    'array'                => 'Isian :attribute harus berupa sebuah array.',
    'before'               => 'Isian :attribute harus tanggal sebelum :date.',
    'before_or_equal'      => 'Isian :attribute harus tanggal sebelum atau sama dengan tanggal :date.',
    'between'              => [
    ...
    'ends_with'            => 'Isian :attribute harus berakhir dengan salah satu nilai dari: :values.',
    'exists'               => 'Isian :attribute yang dipilih tidak valid.',
    'file'                 => 'Isian :attribute wajib berupa file.',
    ...
    'gt' => [
        ...
        'string'  => 'Isian :attribute harus lebih banyak dari karakter :value.',
        'array'   => 'Isian :attribute harus mempunyai jumlah lebih besar dari item :value.',
    ],
    'gte' => [
        ...
        'string'  => 'Isian :attribute harus lebih banyak atau sama dengan karakter :value.',
        'array'   => 'Isian :attribute harus mempunyai jumlah item :value atau lebih.',
    ],
    ...
    'ipv4'                 => 'Isian :attribute harus berupa IPv4 address yang valid.',
    'ipv6'                 => 'Isian :attribute harus berupa IPv6 address yang valid.',
    ...
    'lt' => [
        ...
        'array'            => 'Isian :attribute harus kurang dari jumlah item :value.',
    ],
    'lte' => [
        ...
        'array'             => 'Isian :attribute tidak boleh mempunyai jumlah item lebih dari :value.',
    ],
    'max'                  => [
    ...
    'multiple_of'          => 'Isian :attribute harus berupa data duplikat dari :value.',
    'not_in'               => 'Isian :attribute yang dipilih tidak valid.',
    'not_regex'            => 'format isian :attribute tidak valid invalid.',
    'numeric'              => 'Isian :attribute harus berupa angka.',
    'password'             => 'Isian password tidak benar.',
    ...
    'prohibited_if'        => 'Kolom isian :attribute dilarang ketika :other lebih besar :value.',
    'prohibited_unless'    => 'Kolom isian :attribute harus kurang dari atau sama dengan kecuali :other didalam :values.',
    ...
    'starts_with'          => 'Isian :attribute harus mulai dari kata: :values.',
